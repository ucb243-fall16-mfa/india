...
#Data Wine
The wine data is described in https://www.utdallas.edu/~herve/abdi-WiresCS-mfa-2013.pdf and can for example be found under https://github.com/ucb-stat243/stat243-fall-2016/tree/master/problem-sets/ﬁnal-project
...
The ctr_o_d function also operates on an mfa object, it returns the contribution of an observation o on a dimension d. It takes as an input 
#finish this
